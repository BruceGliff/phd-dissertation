...
\draw[draw=black,fill=black] (axis cs:0.105,0) rectangle (axis cs:0.115,2.15836249209525);
\draw[draw=black,fill=black] (axis cs:0.205,0) rectangle (axis cs:0.215,3.2895889525426);
\draw[draw=black,fill=black] (axis cs:0.305,0) rectangle (axis cs:0.315,3.74083620705731);
\draw[draw=black,fill=black] (axis cs:0.405,0) rectangle (axis cs:0.415,4.57801998503221);
\draw[draw=black,fill=black] (axis cs:0.505,0) rectangle (axis cs:0.515,4.88829746216554);
\draw[draw=black,fill=black] (axis cs:0.605,0) rectangle (axis cs:0.615,5.21851712477091);
\draw[draw=black,fill=black] (axis cs:0.705,0) rectangle (axis cs:0.715,5.58294243056767);
\draw[draw=black,fill=black] (axis cs:0.805,0) rectangle (axis cs:0.815,5.9647525881337);
\draw[draw=black,fill=black] (axis cs:0.905,0) rectangle (axis cs:0.915,6.28133522204542);
\draw[draw=black,fill=black] (axis cs:1.005,0) rectangle (axis cs:1.015,6.60437381770785);
...
\addplot [semithick, red, dash pattern=on 9.6pt off 2.4pt on 1.5pt off 2.4pt]
table {%
