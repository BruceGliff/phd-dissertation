...
\begin{subequations}
    ...
    \begin{align}
      ...
      q & = 1 - \varepsilon,\ \varepsilon \rightarrow 0, \ C_N \approx N! \sum_{k=1}^{N}{\frac{1}{(k-1)!}} \rightarrow eN!, \text{ при } N \rightarrow \infty \label{topo-comp-lims-p0} \\
