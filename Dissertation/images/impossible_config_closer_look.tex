...
\draw[magenta!70, dashed, line width=1.5pt, -{Stealth}] (out1) to (first);
\draw[magenta!70, dashed, line width=1.5pt, -{Stealth}] (out2) to (first);
, line width=1.5pt
\draw[magenta!70, dashed, line width=1.5pt] (second) to (out3);
\draw[cyan, line width=1.5pt, dashed] (second) to (out4);
